...
//        .package(url: "https://source.skip.tools/skip-firebase.git", from: "0.0.0"),
    ...
    targets: [
        .target(name: "SharedQSync", dependencies: [.product(name: "SharedQProtocol", package: "sharedqprotocol")], resources: [.process("Resources")]),
        .target(name: "SharedQAuth", dependencies: [.product(name: "SharedQProtocol", package: "sharedqprotocol")], resources: [.process("Resources")]),
    ]
)
